...
const VoyageInternational = () => {
  ...
  return (
    <div className="max-w-[1534px] mx-auto px-4 sm:px-6 lg:px-8 mb-[120px]">
      ...
      {/* First text section */}
      <motion.p
        className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-[32px] pb-6 sm:pb-8 md:pb-10 lg:pb-12 xl:pb-[50px] leading-relaxed text-center"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        custom={0.4}
      ...
      {/* Second text section */}
      <motion.p
        className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-[32px] pb-12 sm:pb-16 md:pb-20 lg:pb-24 xl:pb-[120px] leading-relaxed text-center"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        custom={0.6}
      ...
      <div className="mainDiv  lg:max-w-[1432px] mx-auto flex flex-col md:flex-row gap-y-8 md:gap-y-0 md:gap-x-0 justify-center items-start md:items-stretch p-0 lg:p-12">
        {/* Mission */}
        <motion.div
          className="parent relative w-full md:w-1/2 border-2 border-[#48553B] rounded-[20px] p-4 lg:p-10 shadow-sm overflow-visible"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          custom={0.8}
