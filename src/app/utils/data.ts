...
export const universityData = [
  {
    ...
    "image": u1,
    "logo": logo1,
    "acceptanceRate": "30%30%",
    "totalInternationalStudents": "77007700",
    "placementRate": "93%93%",
    "studentTeacherRatio": "16:116:1",
    "overview": "The University of New South Wales (UNSW) stands as one of the world’s leading institutions, acclaimed for its excellence in both teaching and research. Located across vibrant campuses in Kensington and Paddington in Sydney, as well as in Canberra, UNSW is a preferred destination for over 16,000 international students. UNSW offers a wealth of interdisciplinary study options, with programs led by globally recognized scholars and seasoned industry professionals. This ensures a practical, career-focused education that equips students with the skills needed for real-world success.",
  ...
  },
  {
    ...
    "placementRate": "93%", // Add from image/data
    "studentTeacherRatio": "16:1", // Add from image/data
    "overview": "INTI International University & Colleges is one of Malaysia’s premier private higher education institutions, established in 1986. It operates multiple campuses across Malaysia, including Nilai (its main campus), Subang, Penang, and Sabah. Known for its strong global partnerships and focus on employability, INTI offers a wide range of academic programs at foundation, diploma, undergraduate, and postgraduate levels.</br> INTI emphasizes a global learning environment, with students from over 55 countries and collaborations with top universities in the UK, USA, Australia, and more. The institution has also gained international recognition, featuring in the QS World University Rankings and achieving notable progress in indicators such as international student ratio, employer reputation, and faculty-student ratio.</br> With a commitment to innovation, academic excellence, and industry-aligned education, INTI provides students with access to global curriculum, real-world projects, and career-focused training, making it a popular choice among both local and international students.", // Add from image/data
    "employability": "", // Add from image/data
  ...
  },
  {
    ...
    "placementRate": "93%", // Add from image/data
    "studentTeacherRatio": "16:1", // Add from image/data
    "overview": "UCSI University, established in 1986 as one of Malaysia’s earliest private higher education institutions, serves over 12,000 students from more than 110 countries across its campuses in Kuala Lumpur, Sarawak (Kuching), and Springhill (Seremban/Port Dickson).</br> The university offers more than 150 undergraduate and postgraduate programs spanning fields such as Medicine, Engineering, Business, Hospitality, Music, Architecture, and Applied Sciences. </br> Its faculty comprises industry-experienced academics with international exposure, fostering a culture of praxis-based learning and strong industry engagement", // Add from image/data
    "employability": "", // Add from image/data
    "rankings": "UCSI University has been ranked within the world’s top 1% of universities for several consecutive years. It climbed to #269 in the QS World University Rankings 2026, after previously ranking 265th in 2025 and 300th in 2024.</br> UCSI also received the QS Recognition for Improvement Award in 2023, being the only global university to earn this title after jumping 63 spots to enter the top 300", // Add from image/data
    "intakes": "UCSI University runs multiple intake periods to accommodate diverse academic programs. Foundation, diploma, undergraduate, and postgraduate coursework programs at the Kuala Lumpur campus typically start in February, May, and September, with orientation occurring shortly before the commencement dates.</br> Specific professional programs such as the Bachelor of Nursing, Optometry, Pharmacy, and various diploma specializations may follow alternative intake cycles, including January, July, or October, depending on program requirements and capacity" // Add from image/data
  },
  {
    "id": 7,
    "uniBanner": udetails7,
  ...
  },
  {
    ...
    "intakes": "Durham University follows the traditional UK academic calendar, with three main terms: Michaelmas (October to December), Epiphany (January to March), and Easter (April to June). The main intake for both undergraduate and postgraduate students is in late September or early October.</br> Undergraduate applications are made via UCAS, with key deadlines in January and June, while postgraduate applications are typically accepted until July for courses starting in autumn." // Add from image/data
  },
  {
    "id": 9,
    "uniBanner": udetails9,
  ...
  },
  {
    ...
    "placementRate": "93%", // Add from image/data
    "studentTeacherRatio": "16:1", // Add from image/data
    "overview": "Lincoln University, established in 1878 and located in Lincoln, Canterbury, New Zealand, is the country's only specialist land-based university. It offers a diverse range of undergraduate and postgraduate programs focusing on agriculture, environmental science, agribusiness, landscape architecture, and tourism.</br> The university emphasizes practical learning and sustainability, providing students with hands-on experience in its own research farms and close ties to industry and government partners. With a student population of approximately 3,000, Lincoln University fosters a close-knit academic community.", // Add from image/data
    "employability": "", // Add from image/data
  ...
  },
  {
    ...
    "placementRate": "93%", // Add from image/data
    "studentTeacherRatio": "16:1", // Add from image/data
    "overview": "Embry‑Riddle Aeronautical University (ERAU), founded in 1926, is a specialized private institution and the largest accredited university system focused solely on aviation and aerospace education. With main residential campuses in Daytona Beach, Florida and Prescott, Arizona, plus online and global branch campuses (including Singapore), it enrolls nearly 31,000 students across undergraduate and graduate programs.</br> ERAU is renowned worldwide for degrees in aeronautical science, aerospace engineering, aviation business, and cybersecurity, and operates industry-aligned research facilities such as the Aerospace Research and Technology Park adjacent to the Daytona Beach campus", // Add from image/data
    "employability": "", // Add from image/data
    "rankings": "ERAU consistently ranks as a national leader in aviation and aerospace education and STEM fields. In the U.S. News & World Report 2024–25 rankings, its Daytona Beach campus is ranked #5 among Regional Universities in the South.</br> ERAU also holds strong reputational standing within aerospace industries, serving as a recognized feeder school to organizations like NASA, Boeing, and SpaceX", // Add from image/data
  ...
  },
  {
    ...
    "intakes": "Drexel operates on a quarter-based academic calendar with four intakes each year: Fall (September), Winter (January), Spring (March), and Summer (June).</br> Application deadlines vary by program and intake, so prospective students should check Drexel’s admissions pages for specific deadlines relevant to their course of interest to ensure timely application submission." // Add from image/data
  },
  {
    "id": 17,
    ...
    "intakes": "Singapore Management University (SMU) offers multiple intakes to accommodate the needs of its diverse student body. For postgraduate programs such as the Master of IT in Business (MITB), there are two main intakes: one in August, with applications typically closing in June, and another in January, with deadlines around October. Other graduate programs also follow similar timelines, with application deadlines varying between June for the August intake and November for the January intake.</br> Undergraduate applications generally open in mid-October and close by mid-March. Prospective students are advised to consult the specific program pages for precise application deadlines and requirements to ensure timely submission." // Add from image/data
  },
  {
    "id": 18,
  ...
  },
  {
    ...
    "employability": "", // Add from image/data
    "rankings": "McGill University is ranked 27th globally in the 2026 QS World University Rankings and is recognized as Canada’s top university. It ranks highly across. </br> numerous disciplines such as psychology, medical and health sciences, law, education, life sciences, social sciences, engineering, computer science, physical sciences, and business and economics. The Schulich School of Music is also internationally acclaimed, ranking within the top 20 worldwide.", // Add from image/data
    "intakes": "McGill University offers multiple intakes for undergraduate and graduate programs. Undergraduate applications typically open in mid-October and close by mid-March. Graduate program deadlines vary by course, with common deadlines in June for the August intake and November for the January intake.</br> Applicants are encouraged to check individual program requirements to meet the specific deadlines." // Add from image/data
  },
  {
    "id": 20,
