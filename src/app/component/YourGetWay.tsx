...
export default function YourGetWay() {
  ...
  <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-y-8 md:gap-y-0 md:gap-x-[92px]">
    ...
    <div className="w-full md:w-[60%] space-y-6">
          ...
          Specializing in study pathways to Abroad, VIE Services provides end-to-end support—
          from choosing the right university to securing your student visa. Our goal is to make your
          international education journey smooth, informed, and successful.
        </p>
        <p className="text-base sm:text-lg md:text-3xl text-gray-800 leading-10">
          Whether you're seeking admission to a top-ranked institution, exploring scholarship
          opportunities, or searching for the ideal course aligned with your career ambitions, VIE Services
          is here to turn your aspirations into reality.
        </p>
      </div>
        <div className="w-full md:w-[40%] mt-6 md:mt-0 flex-shrink-0">
        <Image
          src={Pic.src} // replace with your actual image path
